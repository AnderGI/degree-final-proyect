const { Scrapper } = require("../../domain/ports/ScrapperInterface.cjs");
const puppeteer = require("puppeteer");
const { SoulAutoDomSelectors } = require("../WebConstants/SoulAutoConsts.cjs");
...
module.exports = { SoulAutoScrapper };
