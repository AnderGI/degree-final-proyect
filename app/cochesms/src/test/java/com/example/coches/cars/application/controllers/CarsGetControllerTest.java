...
public class CarsGetControllerTest {
	...
	void it_should_return_empty_array_if_empty_repository() throws Exception{
		...
		.andDo(print()) // Mostrar por consola
		.andExpectAll(
				// 200 OK
				status().isOk(),
	...
	void it_should_return_a_list_of_products_when_get() throws Exception {
        List<Car> expectedCars = Arrays.asList(
                ...
                new Car(new CarTitle("BMW M3"), new CarDescription("Sedán deportivo de lujo"), 
                        new CarBrand("BMW"), new CarPrice(70000.0), 
                        new CarUrl("https://example.com/bmw-m3.jpg"), 
                        new CarUrl("https://example.com/bmw-m3-listing")),
                new Car(new CarTitle("Audi R8"), new CarDescription("Supercar de alta gama"), 
                        new CarBrand("Audi"), new CarPrice(150000.0), 
                        new CarUrl("https://example.com/audi-r8.jpg"), 
